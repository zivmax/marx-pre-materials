...
> 哈耶克将社会概念化为一个分布式信息系统，中央计划者无法希望理解它，因为他们无法获取所有相关信息。只有市场才能正确计算分布在社会中的信息。在发展这一论点时，哈耶克的方法重新想象了市场作为一个巨大的计算机，“传递[...]每个个体需要采取行动，以及理性行动所需的可用信息”。
...
> 这些网络化的社会经济管理形式深深植根于杰伊·福雷斯特和安东尼·斯塔福德·比尔在1950年代和60年代开发的工业控制论中，这些思想家设想“工人、机械和资本作为平衡的输入和输出系统”，旨在将组织重新概念化为信息系统。公司通过网络和信息处理器的“语言”进行重新配置的转变，正如富兰克林所建议的，因此是“控制论传递给晚期资本主义的显著遗产”，即使前者已成为组织大师和管理手册大多未标记的话语。

> 在控制论资本主义下，“信息”不仅是一种商品；它还成为了理解和配置社会世界的核心框架。所有社会、文化和经济实践作为信息系统、网络和其他信息形式的日益表述已成为数字时代的一个关键标志。正如特拉诺瓦所展示的，当代文化已经通过信息化过程，社会和文化过程“呈现信息的属性”，因此“越来越以其信息动态的角度被把握和构想”。在这方面，信息已经构成了我们“时代”的本质。

> 虽然香农的方法为信息理论领域做出了基础性贡献，但它对概率和量化的强调也勾勒出了更广泛的控制论信息理论的关键轮廓，正如凯瑟琳·海尔斯所建议的，将信息转化为非具体和抽象的东西；一个可量化的“实体”或物质，在网络或通信系统中的点之间流动。

> 信息在发送者和接收者之间保持稳定的意义，只通过隐含或明确地划定“意义和表达的‘安全’限制”而存在。因此，被物化为信息的，是那些似乎是经验可观察的、事实的和客观的，其意义因此较不容易受到争议的。
...
> 但这是在暗示，控制论资本主义怀有一种独特的信息逻辑，因为它格式化社会文化机构和实践，倾向于暂停和使政治争议、冲突和批评失效，这些争议、冲突和批评质疑社会系统或结构。它通过将合法知识限制在看似自效的“事实”的简化库存中，并将其余部分过滤为噪声来实现这一点。
